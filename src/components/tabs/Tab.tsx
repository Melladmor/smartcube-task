...
const Tab = (props: Props) => {
  ...
  return (
    <div
      className={`lg:min-w-[143px] md:min-w-[123px] sm:min-w-[103px] xs:w-[90px] lg:h-[48px] md:h-[38px] sm:h-[28px] xs:h-[28px] lg:rounded-[24px] md:rounded-[20px] sm:rounded-[16px] xs:rounded-sm  xs:px-[5px]  ${
