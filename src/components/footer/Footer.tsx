const Footer = () => {
  return (
    <div className="lg:px-[112px] md:px-[20px] sm:px-[20px] xs:px-[0px] fixed bottom-0 left-0 lg:h-[96px] md:h-[86px] sm:h-[70px] xs:h-[70px] w-full bg-white flex lg:justify-end md:justify-center sm:justify-center xs:justify-center items-center">
      <button
